...
frames = [
    ...
    [
        ("3. KOREAN MAE/BIAS QUERY -> /QUERY", 7, COLORS["green"]),
    ...
    [
        ("4. GUARDRAIL", 7, COLORS["green"]),
        ("MODE: DETERMINISTIC_EXPECTED_SQL_REGISTRY_V1", 4, COLORS["white"]),
        ("ONLY CURATED EXPECTED SQL IS MATCHED", 4, COLORS["white"]),
        ("ONLY SELECT SQL IS EXECUTED", 4, COLORS["white"]),
        ("FREE-FORM LLM SQL GENERATION IS NEXT", 4, COLORS["muted"]),
    ],
]

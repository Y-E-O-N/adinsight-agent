...
- 2026-07-20 Session 48: 한국 기업 데이터 엔지니어 제출용 포트폴리오 패키지 작성. README/README.en, 제출용 Markdown, HTML/DOCX export, 지원서 입력 문구, 면접 flashcards, 이력서 최종 bullet 추가. PDF export는 `pdflatex` 부재로 보류.

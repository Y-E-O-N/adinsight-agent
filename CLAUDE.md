...
- Text2SQL eval comparison 최신 결과: `docs/analysis/stage6_text2sql_v1_v2_eval_comparison.md`에 v1 `18 PASS`와 v2 mock `2 PASS / 16 REFUSED / 0 BLOCKED`를 비교했다.
- 다음: Text2SQL v2 provider coverage 확장 또는 real provider integration 설계.

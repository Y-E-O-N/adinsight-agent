...
- Ollama `qwen2.5-coder:7b` eval baseline 최신 결과: gateway `text2sql_gateway_ollama_v1` 경유 positive 24문항 eval은 `8 PASS / 11 FAIL / 5 REFUSED / 0 BLOCKED`, exec_acc `0.4211`, refusal rate `0.2083`, p95 `9528.069ms`, model_score `52.53`, tier `needs_prompt_or_schema_tuning`이다. Negative/content-safety 14문항 eval은 `14/14 PASS`, `negative_pass_rate=1.0`, unsafe echo failures `0`이다. 현재 결론은 safety는 양호하지만 SQL 정확도는 demo primary model로 부족하다.

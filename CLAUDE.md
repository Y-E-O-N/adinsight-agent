...
- 다음: **Stage 1** — `raw.ig_posts` 테이블 설계 + 멱등 loader (`INSERT ... ON CONFLICT`) + DAG load task → 멱등 5회 검증 → **Stage 2** 본수집 (옵션 X: K=600/1000/400 ≈ 2,000 posts ≈ $4.6)
